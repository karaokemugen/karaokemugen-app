...
async function importIniFile(iniFile) {
	...
	if (ini.EngineFreeUpvotesRequiredPercent && +ini.EngineFreeUpvotesRequiredPercent >= 0 && +ini.EngineFreeUpvotesRequiredPercent <= 100) c.Karaoke.Quota.FreeUpVotesRequiredPercent = +ini.EngineFreeUpvotesRequiredPercent;
