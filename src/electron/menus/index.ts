...
export const urls = {
	...
	gitlab: () => shell.openExternal('https://gitlab.com/karaokemugen/karaokemugen-app'),
	changelog: () => shell.openExternal('https://gitlab.com/karaokemugen/karaokemugen-app/-/releases'),
