...
export async function editKaraFromPlaylist(plc_id,params) {
	...
	if (params.flag_free) {
		...
		updateSongsLeft(kara.user_id,playlist_id);
	}
	if (params.pos) {
		await raisePosInPlaylist(params.pos,playlist_id);
		await plDB.setPos(plc_id,params.pos);
