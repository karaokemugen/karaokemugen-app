...
function binMissing(binariesPath: any, err: string) {
	...
	if (process.platform === 'win32') console.log('If the missing file is msvcr120.dll or msvcp120.dll, download Microsoft Visual C++ 2013 Redistribuable Package here : https://www.microsoft.com/en-US/download/details.aspx?id=40784');
}
