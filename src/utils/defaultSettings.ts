...
export const defaults: Config = {
	...
	System: {
		...
		Path: {
			...
			Encores:
				process.platform === 'win32'
					? ['encores', 'encores\\KaraokeMugen']
					: ['encores', 'encores/KaraokeMugen'],
			Import: 'import',
			Intros:
				process.platform === 'win32' ? ['intros', 'intros\\KaraokeMugen'] : ['intros', 'intros/KaraokeMugen'],
			Jingles:
				process.platform === 'win32'
					? ['jingles', 'jingles\\KaraokeMugen']
					: ['jingles', 'jingles/KaraokeMugen'],
			Outros:
				process.platform === 'win32' ? ['outros', 'outros\\KaraokeMugen'] : ['outros', 'outros/KaraokeMugen'],
			Sponsors:
				process.platform === 'win32'
					? ['sponsors', 'sponsors\\KaraokeMugen']
					: ['sponsors', 'sponsors/KaraokeMugen'],
			Temp: 'temp',
			Previews: 'previews',
