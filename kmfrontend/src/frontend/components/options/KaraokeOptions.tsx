			...
			<React.Fragment>
				<div id="nav-karaokeAllMode">
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Karaoke.Quota.FreeUpVote" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Karaoke.SmartInsert" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Karaoke.AutoBalance" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Karaoke.Autoplay" handleChange={onChange}
					...
					{config['Playlist.EndOfPlaylistAction'] === 'random' ?
						<div className="settings-line">
							...
							<div>
								<Switch idInput="Playlist.RandomSongsAfterEndMessage" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.AllowDuplicates" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.Medias.Jingles.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.Medias.Sponsors.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.Medias.Intros.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.Medias.Outros.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Playlist.Medias.Encores.Enabled" handleChange={onChange}
					...
					{config['Karaoke.StreamerMode.Enabled'] ?
						...
						>
							...
							<div className="settings-line">
								...
								<div>
									<Switch idInput="Karaoke.StreamerMode.Twitch.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Karaoke.Poll.Enabled" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Online.FetchPopularSongs" handleChange={onChange}
					...
					<div className="settings-line">
						...
						<div>
							<Switch idInput="Online.Remote" handleChange={onChange}
								isChecked={config['Online.Remote']} />
						</div>
					</div>

					{config['Online.Remote'] ?
						<RemoteStatus /> : null}
					...
					<div className="settings-line">
						...
						<div className='mysterySongs'>
							...
							<div>
								<input value={mysterySongLabel}
									onChange={e => setMysterySongLabel(e.target.value)} />
