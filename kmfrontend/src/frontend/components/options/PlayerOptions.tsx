...
function PlayerOptions(props: IProps) {
	...
	useEffect(() => {
		getDisplays();
		getAudioDevices(); (dotify(context.globalState.settings.data.config));
	}, []);


	if (config['Player.Display.ConnectionInfo.Host'] === null) config['Player.Display.ConnectionInfo.Host'] = '';
	const listAudio = useMemo(() => audioDevices?.map(device => (
	...
	const listdisplays = useMemo(() => displays?.map((display: any, index: number) => (
		...
		config ?
			<React.Fragment>
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.StayOnTop" handleChange={putPlayerCommando}
							isChecked={config['Player.StayOnTop']} nameCommand="toggleAlwaysOnTop" />
					</div>
				</div>
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.FullScreen" handleChange={putPlayerCommando}
							isChecked={config['Player.FullScreen']} nameCommand="toggleFullscreen" />
					</div>
				</div>
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Borders" handleChange={putPlayerCommando}
							isChecked={config['Player.Borders']} nameCommand="toggleBorders" />
					</div>
				</div>
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Monitor" handleChange={onChange}
				...
				<div className="settings-line">
					...
					<div>
						<select
							id="App.Language"
							onChange={onChange} defaultValue={config['App.Language']}>
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Display.RandomQuotes" handleChange={onChange}
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Display.ConnectionInfo.Enabled" handleChange={onChange}
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Display.Nickname" handleChange={onChange}
				...
				<div className="settings-line">
					...
					<div>
						<Switch idInput="Player.Display.Avatar" handleChange={onChange}
