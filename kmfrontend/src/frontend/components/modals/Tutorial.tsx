...
function Tutorial() {
	...
	switch (stepIndex) {
					...
					<div className="kara-line-image">
						...
						<p className="caption-left">
							<Trans
								...
								components={{ 1: !isLargeDevice ? <span /> : null }}
							/>
							<br />
							<Trans
		...
		case 2:
			slide = <div className="player-presentation">
				...
				<div className="center"><button onClick={nextStep} className="step inline">
	...
	return (<div className="tutorial">
		...
		{slide}
		<div className="steps">
			{stepIndex > 0 ? <button onClick={previousStep} className="step back">
				<i className="fas fa-arrow-left" /> {i18next.t('MODAL.TUTORIAL.BACK')}
			</button> : null}
			{stepIndex < 2 ? <button onClick={nextStep} className="step next">
