		...
		kara ?
			<ul
				...
				{playlist.plaid !== nonStandardPlaylists.favorites ?
					<li className="animate-button-container">
						...
						<a href="#" className={`animate-button-success${effectFavorite ? ' activate' : ''}`}>
							...
							&nbsp;
							{kara.flag_favorites ? i18next.t('KARA_MENU.FAVORITES_REMOVED') : i18next.t('KARA_MENU.FAVORITES_ADDED')}
						</a>
					</li> : null
				}
				...
				{!isNonStandardPlaylist(playlist.plaid) ?
					<li className="animate-button-container">
						<a href="#" onClick={changeVisibilityKara}
							title={kara.flag_visible ? i18next.t('KARA_MENU.VISIBLE_OFF') : i18next.t('KARA_MENU.VISIBLE_ON')}>
							{kara.flag_visible ?
								<React.Fragment>
