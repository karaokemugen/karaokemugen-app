...
(function (root, factory) {
  ...
  */
  ...
  function _determineAutoPosition(targetElement, tooltipLayer, desiredTooltipPosition) {
    ...
    console.log(desiredTooltipPosition, windowSize, tooltipHeight, tooltipWidth, targetOffset);
    console.log(targetOffset.left , tooltipWidth , windowSize.width , targetOffset.left , targetOffset.width / 2, tooltipWidth, ((targetOffset.left + (targetOffset.width / 2)) - tooltipWidth) < 0);
    // Check if the width of the tooltip + the starting point would spill off the right side of the screen
    // If no, neither bottom or top are valid
    if (targetOffset.left + tooltipWidth > windowSize.width || ((targetOffset.left + (targetOffset.width)) - tooltipWidth) < 0) {
