        ...
        return (
            <React.Fragment>
                {(this.props.scope === 'admin' && this.props.idPlaylistTo !== -1 && this.props.idPlaylistTo !== -6) ||
                    ...
                    <button title={this.props.t('TOOLTIP_ADDKARA') + (this.props.scope == 'admin' ? ' - ' + this.props.t('TOOLTIP_ADDKARA_ADMIN') : '')}
                ...
                {this.props.scope === 'admin' && this.props.idPlaylist !== -1 && this.props.idPlaylist !== -6 ?
                    <button title={this.props.t('TOOLTIP_DELETEKARA')} name="deleteKara"
                ...
                {this.props.scope === 'admin' && this.props.idPlaylistTo >= 0 && this.props.idPlaylist >= 0 ?
                    <button title={this.props.t('TOOLTIP_TRANSFERKARA')} name="transferKara" className={classValue}
