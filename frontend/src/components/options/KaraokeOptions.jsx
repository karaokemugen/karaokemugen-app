...
class KaraokeOptions extends Component {
  ...
  deleteMysterySongLabel = value => {
  	var settings = this.state.settings;
  	this.state.settings['Playlist.MysterySongs.Labels'] = this.state.settings['Playlist.MysterySongs.Labels'].filter(function (ele) {
  		return ele != value; 
  	});
  	this.setState({ settings: settings });
  	this.saveMysterySongsLabels(this.state.settings['Playlist.MysterySongs.Labels'].filter(function (ele) {
  		return ele != value; 
  	}));
  };
