ALTER TABLE tag ADD COLUMN modified_at timestamptz;
ALTER TABLE serie ADD COLUMN modified_at timestamptz;

UPDATE tag SET modified_at = '1982-04-06';
UPDATE serie SET modified_at = '1982-04-06';

ALTER TABLE tag ALTER modified_at SET NOT NULL;
ALTER TABLE serie ALTER modified_at SET NOT NULL;
