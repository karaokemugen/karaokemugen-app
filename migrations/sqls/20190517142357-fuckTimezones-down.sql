...
ALTER TABLE kara ALTER created_at TYPE timestamp;
ALTER TABLE kara ALTER modified_at TYPE timestamp;
ALTER TABLE users ALTER last_login_at TYPE timestamp;
ALTER TABLE whitelist ALTER created_at TYPE timestamp;
ALTER TABLE played ALTER session_started_at TYPE timestamp;
ALTER TABLE played ALTER played_at TYPE timestamp;
ALTER TABLE requested ALTER session_started_at TYPE timestamp;
ALTER TABLE requested ALTER requested_at TYPE timestamp;
ALTER TABLE playlist ALTER created_at TYPE timestamp;
ALTER TABLE playlist ALTER modified_at TYPE timestamp;
ALTER TABLE playlist_content ALTER created_at TYPE timestamp;
ALTER TABLE blacklist ALTER created_at TYPE timestamp;
