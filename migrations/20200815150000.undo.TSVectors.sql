...
create index idx_ak_tags
    on all_karas (tags_searchable);

create index idx_ak_tags_i18n
    on all_karas (tags_i18n_searchable);

create index idx_ak_tags_aliases
    on all_karas (tags_aliases_searchable);
...
create index idx_at_search_aliases
    on all_tags (search_aliases);
